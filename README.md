...
Dynamiq is designed to push the boundaries of vehicle simulation with:  

- **Immersive Physics:** Realistic soft-body vehicle dynamics, damage systems, and handling.  
- **Expansive Vehicle Roster:** 40–59 fully modeled cars with unique tuning and customization.  
...
We are very disappointed to announce that **Dynamiq will no longer be free-to-play**. This decision allows us to maintain the **high-fidelity, large-scale experience** we want to deliver, including advanced physics, vast maps, and detailed vehicles. Every purchase directly contributes to the game’s growth and improvement.  

---

## 💬 Stay Connected

If you want to **keep up with development, join beta testing, or see unreleased maps early**, join our **official Discord server**:  

[**Join the Strata Dynamics Discord**](https://discord.gg/hRq35Kcmqv)  

By joining, you’ll get:  
- Early access to upcoming maps and content  
- A chance to provide direct feedback  
- Exclusive insights into development progress  
